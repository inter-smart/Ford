        ...
        <div className="flex flex-wrap -mx-[6px] xl:-mx-[8.5px] 2xl:-mx-[10.5px] 3xl:-mx-[13px]">
          {data?.cards?.map((item, idx) => {
            return (
              <div
                key={"branch" + idx}
                className="w-full sm:w-1/4 p-[6px] xl:p-[8.5px] 2xl:p-[10.5px] 3xl:p-[13px]"
              >
                <div className="w-full h-full border-[0.5px] border-[#c4c4c4] p-[18px_15px] sm:p-[20px_18px] xl:p-[24px_22px] 2xl:p-[28px_26px] 3xl:p-[36px_33px]">
