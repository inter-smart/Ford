    ...
    <section className="w-full h-auto block py-5 sm:py-[30px] xl:py-[37px] 2xl:py-[45px] 3xl:py-[55px]">
      <div className="container">
        <Heading
          as="h2"
          size={"none"}
          className="text-[20px] lg:text-[27px] xl:text-[33px] 2xl:text-[40px] 3xl:text-[50px] leading-normal font-medium text-black mb-[15px] xl:mb-[35px] 2xl:mb-[40px] 3xl:mb-[50px]"
        >
          {data?.title}
        </Heading>
        <Image
          ...
          width={1745}
          height={802}
          className="w-full aspect-[1745/802] object-contain transition-transform duration-300 hover:scale-101 mb-[15px] xl:mb-[35px] 2xl:mb-[40px] 3xl:mb-[50px]"
        />
