  ...
  return (
    <section className="w-full h-auto block py-5 sm:py-[30px] xl:py-[37px] 2xl:py-[45px] 3xl:py-[55px]">
      <div className="container">
        ...
        <div className="flex flex-wrap -mx-[5px] xl:-mx-[10px] 2xl:-mx-[12px] 3xl:-mx-[15px] mt-[30px] xl:mt-[70px] 2xl:mt-[80px] 3xl:mt-[100px]">
          {data?.items?.map((item, idx) => {
            return (
              ...
              >
                <div
                  className={cn(
                    "w-full h-full bg-[#00095b] rounded-[8px] 2xl:rounded-[10.6px] 3xl:rounded-[13.3px] p-[25px_15px] sm:p-[46px_41px] xl:p-[58px_52px] 2xl:p-[70px_62px] 3xl:p-[88px_77px] transition-all duration-300 border border-[#e5e5e5]",
                    idx === 0 ? "bg-[#00095b]" : "bg-[#066fef]",
                  )}
                >
                  <div className="text-[18px] sm:text-[21.3px] xl:text-[26.7px] 2xl:text-[32px] 3xl:text-[40px] leading-normal font-semibold text-white mb-[20px] xl:mb-[25px] 2xl:mb-[30px] 3xl:mb-[35px]">
                    {item?.title}
                  </div>
                  <Text
                    as="div"
                    size="text1"
                    className="text-white [&_p]:mb-[15px] xl:[&_p]:mb-[25px] 2xl:[&_p]:mb-[30px] 3xl:[&_p]:mb-[35px] mb-[10px] xl:mb-[15px] 2xl:mb-[25px] 3xl:mb-[30px]"
                  >
