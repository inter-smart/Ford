    ...
    <section className="w-full h-auto block py-5 sm:py-[30px] xl:py-[37px] 2xl:py-[45px] 3xl:py-[55px]">
      <div className="container">
        <Heading
          as="h2"
          size={"none"}
          className="text-[20px] lg:text-[27px] xl:text-[33px] 2xl:text-[40px] 3xl:text-[50px] leading-normal font-normal text-black mb-[10px] xl:mb-[32px] 2xl:mb-[40px] 3xl:mb-[50px]"
        >
          {data?.title}
        </Heading>
        <div className="flex flex-wrap -mx-[4px] sm:-mx-[6px] xl:-mx-[8.5px] 2xl:-mx-[10.5px] 3xl:-mx-[13px]">
          {data?.items?.map((item, idx) => {
            return (
              <div
                key={"replaced" + idx}
                className={cn(
                  "w-full sm:w-1/2 lg:w-1/4 p-[4px] sm:p-[6px] xl:p-[8.5px] 2xl:p-[10.5px] 3xl:p-[13px]",
                  idx === 0 ? "w-full sm:w-full lg:w-1/2" : "",
                )}
              >
                <div
                  className={cn(
                ...
                >
                  <div className="text-[14px] xl:text-[17.7px] 2xl:text-[21.3px] 3xl:text-[26.6px] leading-normal font-medium text-[#066fef] mb-[6px] xl:mb-[7px] 2xl:mb-[8px] 3xl:mb-[15px]">
                    {item?.title}
                  </div>
                    ...
                    {item?.infoItems?.map((infoItem, infoIdx) => {
                      return (
                        <div
                          ...
                          className={cn(
                            "p-[5px] 2xl:p-[10px]",
                            idx === 0 ? "w-1/2 sm:w-1/4" : "w-1/2 sm:w-1/2",
                          )}
                        >
