            ...
            <div className="w-full  3xl:max-w-[840px]">
              ...
              <Link
                ...
                className="text-[10px] lg:text-[12px] xl:text-[13px] 2xl:text-[15px] 3xl:text-[16px] leading-[1] font-medium font-antenna text-white w-fit min-w-[135px]  xl:min-w-[165px] 2xl:min-w-[200px] 3xl:min-w-[250px] h-[30px] xl:h-[35px] 2xl:h-[40px]  
                                3xl:h-[53px] bg-[#1A73E8] px-3 rounded-full flex items-center justify-center transition cursor-pointer hover:bg-[#005fd3]
              ...
              <div className="flex flex-col">
                {data?.features?.map((item, index) => (
                  <div
                    key={index}
                    className="mb-[15px] lg:mb-[20px] xl:mb-[25px] 2xl:mb-[30px] 3xl:mb-[35px] last-of-type:mb-0"
                  >
