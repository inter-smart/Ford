        ...
        <Link href={`/offers/${item?.slug || ""}`} className="block">
            <div className="w-full h-full block group bg-[#F7F7F7] rounded-[5px] lg:rounded-[8px] 2xl:rounded-[10px] overflow-hidden">
                ...
                <div className="w-full h-auto p-[20px_18px] xl:p-[28px_24px] 2xl:p-[34px_27px] rounded-[5px] lg:rounded-[8px] 2xl:rounded-[10px]">
                    <Heading
                        as="h2"
                        className="text-[16px] xl:text-[20px] 2xl:text-[25px] 3xl:text-[30px] leading-[1.35] font-semibold text-[#00095B] w-[50%] mb-[10px] xl:mb-[15px] 2xl:mb-[20px]"
                    >
                        {item?.title}
                    </Heading>
                    <Heading
                    ...
                    <div className="w-auto flex justify-center">
                        <button
                        className="text-[10px] xl:text-[12px] 2xl:text-[15px] 3xl:text-[17px] leading-[1] font-bold text-[#ffffff] mr-auto px-6 py-3 rounded-[20] bg-[#066FEF] cursor-pointer transition-all">
                        {item?.btnTxt}
                        </button>
                    </div>
                </div>
