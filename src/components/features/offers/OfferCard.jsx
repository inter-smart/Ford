...
export default function OfferCard({ data }) {
  ...
  return (
    <Link
      ...
      className="w-full h-full flex flex-col group bg-[#F7F7F7] rounded-[8px] 2xl:rounded-[10.6px] 3xl:rounded-[13.3px] overflow-hidden"
    >
      ...
      <div className="flex-1 w-full h-auto p-[15px_10px] sm:p-[15px_20px] xl:p-[28px_24px] 2xl:p-[34px_27px] flex flex-col">
        <Heading
          as="h2"
        ...
        <div className="w-auto flex justify-center mt-auto">
          <button className="text-[10px] xl:text-[12px] 2xl:text-[15px] 3xl:text-[17px] leading-[1] font-bold text-white ltr:mr-auto rtl:ml-auto px-6 py-3 rounded-[20] bg-[#066FEF] cursor-pointer transition-all hover:bg-[#005fd3]">
            Know More
          </button>
        </div>
      </div>
