            ...
            <div className="container">
                <div className="w-full h-full 2xl:p-[125px_165px] xl:p-[110px_95px] md:p-[60px_40px] sm:p-[30px_20px] p-[25px_15px] rounded-[10px] overflow-hidden flex items-center relative
                    ...
                    <div className="w-full flex flex-wrap justify-between relative z-1 gap-3">
                        <div className="relative w-full z-0 2xl:max-w-[450px] lg:max-w-[380px] md:max-w-[300px]">
                            ...
                            <Button
                                variant="outline"
                                className="md:text-[14px] sm:text-[12px] text-[10px]  font-medium w-full h-[40px] mb-[15px] relative flex items-center justify-start transition-all shadow-0 2xl:max-w-[400px] md:max-w-[350px] rounded-[5px] 
                            ...
                            <div className="relative w-full 2xl:max-w-[400px] md:max-w-[350px]">
                                <Input
                                    ...
                                    className="md:text-[14px] sm:text-[12px] text-[10px] h-[40px] pr-10 pl-4  text-[#6F6F6F] bg-white rounded-[5px]
                                    border-none shadow-none outline-none 
                                    focus:outline-none focus:border-none focus:ring-0 focus:shadow-none"
                                />
                                <Button className="absolute top-0 right-[15px] bottom-0 my-auto w-[17px] h-[17px] cursor-pointer group">
