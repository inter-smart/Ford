        ...
        <div className="w-full">
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} >
                    ...
                    {/* Submit Button */}
                    <Button type="submit" className="text-[14px] font-bold text-white bg-[#1577F0] hover:bg-[#0f5eda] px-10 h-[40px] 2xl:h-[45px] 3xl:h-[50px] mt-[20px] rounded-full cursor-pointer"
                    >   Send
                    </Button>
                </form>
            </Form>
