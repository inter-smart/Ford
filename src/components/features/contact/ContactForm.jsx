              ...
              <FormItem className="relative w-full mb-[15px] 2xl:mb-[20px] 3xl:mb-[30px]">
                <FormControl>
                  <Input
                    ...
                    placeholder=" "
                    className="peer text-[12px] 2xl:text-[14px] 3xl:text-[16px] font-normal text-[#000000] w-full pb-[15px] 3xl:pb-[20px] pt-[30px] 3xl:pt-[35px] border-none border-b border-[#D9D6CE] rounded-none px-0 focus-visible:ring-0 focus:border-black"
                  />
                </FormControl>
                <FormLabel className="absolute left-0 top-[20px] text-[12px] 2xl:text-[14px] 3xl:text-[16px] font-normal text-[#000000] transition-all duration-200 peer-focus:top-0 peer-focus:text-[12px] peer-focus:text-black peer-[:not(:placeholder-shown)]:top-0 peer-[:not(:placeholder-shown)]:text-[12px] peer-[:not(:placeholder-shown)]:text-black pointer-events-none">
              ...
              <FormItem className="relative w-full mb-[15px] 2xl:mb-[20px] 3xl:mb-[30px]">
                <FormControl>
                  <Textarea
                    ...
                    placeholder=" "
                    rows={3}
                    className="peer text-[12px] 2xl:text-[14px] 3xl:text-[16px] font-normal text-[#000000] w-full pb-[15px] 3xl:pb-[20px] pt-[35px] 3xl:pt-[40px] border-none border-b border-[#D9D6CE] rounded-none min-h-[50px] px-0 focus-visible:ring-0 focus:border-black resize-none"
                  />
                </FormControl>
                <FormLabel className="absolute left-0 top-[20px] text-[12px] 2xl:text-[14px] 3xl:text-[16px] font-normal text-[#000000] transition-all duration-200 peer-focus:top-0 peer-focus:text-[12px] peer-focus:text-black peer-[:not(:placeholder-shown)]:top-0 peer-[:not(:placeholder-shown)]:text-[12px] peer-[:not(:placeholder-shown)]:text-black pointer-events-none">
                  Message
