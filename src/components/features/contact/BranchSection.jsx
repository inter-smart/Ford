        ...
        <section className="py-[35px] 2xl:py-[50px_40px] 3xl:py-[80px_45px]">
            <div className="container">
                ...
                <div className="flex flex-wrap gap-0">
                    {branches.map((branch) => (
                        <div key={branch.id} className="w-full xs:w-1/2 md:w-1/3 xl:w-1/4">
                            <div className="w-full h-full border border-[rgba(0,0,0,0.1)] p-[20px] 2xl:p-[25px] flex flex-col justify-between">
                                <div className="w-full">
                                    ...
                                    <a href={`tel:${branch.phone}`} className="flex items-center mb-[8px] transition-all hover:text-[#0f5eda]">
                                        ...
                                        <span className="px-[8px] text-[14px]">{branch.phone}</span>
                                    </a>
                                    ...
                                    <div className="flex items-center mb-[8px]">
                                        <div className="w-[15px] h-[15px] flex items-center">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g clipPath="url(#clip0_1693_6711)">
                                                    <path d="M10.8491 9.41194L8.61828 7.73881V4.33062C8.61828 3.98794 8.34128 3.71094 7.99859 3.71094C7.65591 3.71094 7.37891 3.98794 7.37891 4.33062V8.04869C7.37891 8.24388 7.47062 8.42794 7.62678 8.54444L10.1055 10.4035C10.217 10.4871 10.3472 10.5274 10.4767 10.5274C10.6657 10.5274 10.8516 10.4425 10.973 10.2789C11.1788 10.0056 11.123 9.61706 10.8491 9.41194Z" fill="#1577F0" />
                                                    <path d="M8 0C3.58853 0 0 3.58853 0 8C0 12.4115 3.58853 16 8 16C12.4115 16 16 12.4115 16 8C16 3.58853 12.4115 0 8 0ZM8 14.7607C4.27266 14.7607 1.23934 11.7273 1.23934 8C1.23934 4.27266 4.27266 1.23934 8 1.23934C11.728 1.23934 14.7607 4.27266 14.7607 8C14.7607 11.7273 11.7273 14.7607 8 14.7607Z" fill="#1577F0" />
                                                </g>
                                                <defs>
                                        ...
                                        <span className="px-[8px] text-[14px]">{branch.timing}</span>
                                    </div>
