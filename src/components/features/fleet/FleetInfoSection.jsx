...
export default function FleetInfoSection({}) {
  return (
    <section className="w-full h-auto block pt-5 sm:pt-[40px] xl:pt-[60px] 2xl:pt-[75px] 3xl:pt-[85px] pb-5 sm:pb-[40px] xl:pb-[60px] 2xl:pb-[75px] 3xl:pb-[85px]">
      <div className="container">
        <div className="flex flex-wrap items-center -mx-[20px] xl:-mx-[30px] 2xl:-mx-[40px] 3xl:-mx-[100px] [&>*]:px-[20px] xl:[&>*]:px-[30px] 2xl:[&>*]:px-[40px] 3xl:[&>*]:px-[100px]">
          <div className="w-full sm:w-1/2">
            <div className="w-full aspect-[610/376] overflow-hidden">
              <Image
          ...
          <div className="flex flex-wrap items-center gap-5">
            <div className="flex-1">
              <Text
                as="div"
                size="text1"
                className="text-[black] max-w-[655px] xl:max-w-[820px] 2xl:max-w-[980px] 3xl:max-w-[1180px]"
              >
                <p>
            ...
            <div className="w-[110px] lg:w-[116px] xl:w-[145px] 2xl:w-[174px] 3xl:w-[218px]">
              <Link
                href={"/"}
                className="text-[10px] xl:text-[12px] 2xl:text-[14.5px] 3xl:text-[18px] leading-[1] font-bold text-white w-full h-[28.5] xl:h-[35.5] 2xl:h-[42.6] 3xl:h-[53.4] p-2 rounded-full bg-[#066FEF] cursor-pointer transition-all flex items-center justify-center"
              >
                Request a Quote
              </Link>
            </div>
