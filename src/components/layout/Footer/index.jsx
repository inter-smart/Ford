...
export default function welcome({ data: footerData }) {
  const first_menu_section = footerData?.first_menu_section;
  const second_menu_section = footerData?.second_menu_section;
  return (
