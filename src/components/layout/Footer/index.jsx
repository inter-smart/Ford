                                ...
                                <div className="flex gap-3 lg:max-w-[380px] sm:max-w-[300px] w-full">
                                    <div className="w-1/2">
                                        <Link href="#" className="w-full 2xl:h-[55px] h-[45px] border border-white 2xl:rounded-[10px] rounded-[5px]  flex items-center px-[15px] justify-center group hover:bg-[#010D7E]">
                                            <Image src="/images/googlePlay.png" alt="Google Play" width={140} height={35} className="w-full h-full transition-all object-contain 2xl:max-w-[130px] max-w-[100px] group-hover:scale-[0.75]" />
                                        </Link>
                                    </div>
                                    <div className="w-1/2">
                                        <Link href="#" className="w-full 2xl:h-[55px] h-[45px]  border border-white 2xl:rounded-[10px] rounded-[5px] flex items-center px-[15px] justify-center group hover:bg-[#010D7E]">
                                            <Image src="/images/appStore.png" alt="App Store" width={140} height={35} className="w-full h-full transition-all object-contain 2xl:max-w-[130px] max-w-[100px] group-hover:scale-[0.75]" />
                                        </Link>
                                    </div>
                                </div>
                            </div>
                 ...
                 after:left-0 after:right-0 after:h-[1px] after:w-full after:bg-[#051EFF] after:m-auto after:z-[-1] max-sm:after:hidden max-xs:text-center max-xs:justify-center">
                    ...
                    <div className="flex items-center gap-2 bg-[#00095B] p-[5px]">
                        ...
                        <a href="" className="d-block w-12px h-[12px]">
                            <Image src="/images/intersmart.svg" alt="App Store" width={12} height={12} className="w-full h-full max-w-[12px] mx-[3px]" />
                        </a>
                    </div>
                </div>
            </div>
