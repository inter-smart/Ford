    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        <DialogHeader className="sr-only">
          ...
          <DialogDescription>
            To book your Test Drive, complete all of the fields below and select
            your preferred booking date and time slot.
          </DialogDescription>
        </DialogHeader>
        <div className="w-full">
          ...
          <div className="typography [&_p]:last:mb-0 [--text-color:#000] mb-[10px] xl:mb-[10px] 2xl:mb-[15px] 3xl:mb-[20px]">
            <p>
              To book your Test Drive, complete all of the fields below and
