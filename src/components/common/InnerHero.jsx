    ...
    <section className="w-full h-auto min-h-[350px] sm:min-h-[450px] xl:min-h-[540px] 2xl:min-h-[580px] flex items-end relative z-0 
     ...
     ">
      ...
      <picture className="absolute -z-2 inset-0">
        <source media="(max-width: 640px)" srcSet={data?.mobile_image?.url || data?.backgroundImage?.url} />
        <Image
          src={data?.desktop_image?.url || data?.backgroundImage?.url || "/images/placeholder.png"}
