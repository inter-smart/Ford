          ...
          <div className="flex flex-wrap items-center -mx-[15px] xl:-mx-[19px] 2xl:-mx-[23px] 3xl:-mx-[28px] [&>*]:px-[15px] xl:[&>*]:px-[19px] 2xl:[&>*]:px-[23px] 3xl:[&>*]:px-[28px]">
            ...
            <div className="w-full sm:w-1/2">
              <Heading
                as="h2"
                size="none"
                className="text-[20px] lg:text-[27px] xl:text-[33px] 2xl:text-[40px] 3xl:text-[50px] leading-tight font-semibold text-black mb-[10px] xl:mb-[15px] 2xl:mb-[20px] 3xl:mb-[25px]"
              >
                Enquire Now
              </Heading>
              <div className="typography [--text-color:#000]">
                <p>
                  ...
                  type and send us your enquiry and we will aim to get back to
