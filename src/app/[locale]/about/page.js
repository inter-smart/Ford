...
const local_data = {
  ...
  findFordSection: {
    ...
    description:
      "With an extensive network of branches and service centers across Oman, you're never far from a Ford expert. Visit any of our locations for sales, support, and service.",
    locations: [
      {
        id: 1,
        name: "Ford Muscat - Wattayah",
        lat: 23.601,
        lng: 58.565,
        address: "Wattayah, Muscat, Oman",
      },
      {
        id: 2,
        name: "Ford Muscat - Al Ghubrah",
        lat: 23.585,
        lng: 58.375,
      ...
      },
      {
        ...
        lat: 17.021,
        lng: 54.101,
        address: "Salalah Industrial Area, Oman",
      },
      {
        id: 4,
        name: "Ford Sohar",
